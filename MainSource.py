        ...
        for i in range(len(boxes)):
            if i in indices:
                ...
                if label.lower() in product_prices:
                    ...
                    cv2.rectangle(frame, (0, 0), (440, 200), (100, 100, 100), cv2.FILLED)
                    cv2.putText(frame, f"Weight: {weight} gr", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 255, 255), 2)
                    cv2.putText(frame, f"Total Price: {total_price:.2f} GEL", (20, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 255, 255), 2)
                    cv2.putText(frame, f"1KG Price: {price} GEL", (20, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 255, 255), 2)
                    cv2.putText(frame, f"You can start payment", (20, 180), cv2.FONT_HERSHEY_SIMPLEX, 1.1, (0,0,255), 3)
...
class WeightScanner:
    def __init__(self, arduino_port, audio_event):
        self.arduino = serial.Serial(arduino_port, 57600)
    ...
    def play_audio_message(self, message):
        print(message)
        audio_mapping = {
            "Access denied": "./FailSound.m4r",
            "Authorized access": "./SuccessSound.m4r",
